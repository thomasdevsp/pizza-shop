...
type OrderFitersSchema = z.infer<typeof orderFiltersSchema>
...
export function OrderTableFilters(){
  ...
  const { register, handleSubmit, control, reset } = useForm<OrderFitersSchema>({
  ...
  function handleFilter({ orderId, customerName, status }: OrderFitersSchema) {
